...
* -> Function Declaration (gcd)
  4:     ST  1,0(5) 	function : store the location of func. entry
...
* -> Function Declaration (main)
 58:     ST  1,-1(5) 	function : store the location of func. entry
* function : unconditional jump to next declaration belongs here
* function : function body starts here
 57:    LDC  1,60(0) 	function : load function location
 60:     ST  0,-1(6) 	function : store return address
* -> compound
* -> assign
* -> Id (x)
